  ...
  return (
    <main className="min-h-screen bg-background pt-24 pb-20">
      ...
      <div className="container-custom max-w-4xl pt-10">
        ...
        {/* Stats bar */}
        <div className="flex flex-wrap gap-6 text-sm text-muted bg-white rounded-2xl px-8 py-5 shadow-sm mb-10">
          ...
          <div className="ml-auto flex gap-3">
            ...
            {cs.githubUrl && (
              <a href={cs.githubUrl} target="_blank" rel="noopener noreferrer"
                className="inline-flex items-center gap-1.5 bg-surface text-foreground px-4 py-1.5 rounded-full text-xs font-medium shadow-sm hover:text-primary transition-colors">
          ...
          <div className="mb-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {cs.gallery.map((img: string, i) => (
                <div key={i} className="relative aspect-video rounded-2xl overflow-hidden bg-surface">
        ...
        {/* Testimonial */}
        {cs.testimonial && (
          <blockquote className="bg-primary-tint rounded-2xl px-8 py-6 mb-10">
